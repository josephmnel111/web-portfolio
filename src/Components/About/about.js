        ...
        <div className = "About" ref = {ref}>
            ...
            <div className = "AboutContent">
                <div className = "AboutSummary">
                    <p>
                        &emsp;I am trying to pursue my passion in software engineering and am looking for a company where I can 
                        help them meet their goals. I graduated with a degree in Computer and Information Science from U of M -
                        Dearborn. I live in Canton, MI, and I code personal projects and do freelancing
                        on the side while I look for a new role. I enjoy problem solving and finding the most efficient
                        solutions. I have a completed a lot of projects in web development, but I am
